...
const int Constants::nrOfVerticesPerCircle = 40;
...
const float Constants::bulletSpawnCooldown = 0.4;
const float Constants::bulletRadius = 3.0f;
const int Constants::nrOfBulletsPerFrame = 7;
